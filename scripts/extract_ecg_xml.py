...
if __name__ == "__main__":
	...
	parser.add_argument("--samples", help="number of samples per ecg file (default 2500)", default=2500, type=int)
	args = parser.parse_args()

	convert_xml_to_csv(remove_trailing_slash(args.source_dir), 
		remove_trailing_slash(args.dest_dir), args.samples)
