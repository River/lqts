# Source https://github.com/kweimann/ecg-transfer-learning ResNet-18v2
# 
# Architecturally, our net- works follow the design of the improved residual
# networks proposed by He et al.22 with some small adjustments. Due to the
# dimensionality of the input (i.e. ECG data is 1-dimensional), we replace
# the 2-dimensional convolu- tional layers with their 1-dimensional
# counterparts. Furthermore, we use larger filter sizes, i.e. 7, 5, 5, and 3
# at each stage respectively, which we have observed to outperform the
# suggested smaller 3 × 3 filters. The remaining architectural decisions and
# hyperparameters, including the weight initialization scheme, are the same
# as in He et al.22.
# 
# ResNet18v2 paper: 
# He,K.,Zhang,X.,Ren,S.,&Sun,J. Identity Mappings in Deep Residual Networks
# (2016). arXiv:1603.05027.
